<div class="container mt-5">
    ...
    <table class="table">
        <thead>
            <tr>
                <th scope="col" class="bg-dark text-white">Código</th>
                ...
                <th scope="col" class="bg-dark text-white"><button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#cadadm">CADASTRAR</button></th>
            </tr>
        </thead>
        <tbody>
            <?php
